...
const FIXED_AMOUNT: i128 = 10_000_000; // 1 USDC (7 decimal places on Stellar)
...
impl PrivacyPoolsContract {
    ...
    pub fn withdraw(
        ...
        // No require_auth on `to` — the ZK proof is the authorization.
        // Any caller with a valid proof can withdraw to any funded address.
